...
const Project = (props) => {
  return (
    <div class="mx-4 rounded-md p-4 text-center relative">
      ...
      <div class="absolute text-gray-600 inset-0 rounded-md z-10 bg-white text-center flex flex-col items-center justify-center space-y-6 opacity-0 hover:opacity-100 bg-opacity-90 transition-opacity duration-300">
        <h2>{props.title}</h2>
